  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch(
        `https://ebube-be.onrender.com/api/admin/users/${user.id}/fund`,
        {
          method: "POST",
          headers: {
...
const UsersManagement = () => {
  ...
  const fetchUsers = async () => {
    try {
      ...
      const response = await fetch("https://ebube-be.onrender.com/api/users", {
        method: "GET",
        headers: {
          Authorization: `Bearer ${token}`,
          "Content-Type": "application/json",
  ...
  const handleSuspendUser = async (user) => {
    try {
      ...
      const token = getAuthToken();
      const response = await fetch(
        `https://ebube-be.onrender.com/api/users/${user.id}/suspend`,
        {
          method: "PUT",
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  const handleActivateUser = async (user) => {
    try {
      ...
      const token = getAuthToken();
      const response = await fetch(
        `https://ebube-be.onrender.com/api/users/${user.id}/activate`,
        {
          method: "PUT",
          headers: {
            Authorization: `Bearer ${token}`,
