...
const PendingWithdrawals = () => {
  ...
  const fetchWithdrawals = async () => {
    try {
      ...
      const response = await fetch(
        "https://ebube-be.onrender.com/api/admin/transactions/withdrawals/pending",
        {
          method: "GET",
          headers: {
  ...
  const approveWithdrawal = async (id) => {
    try {
      ...
      const response = await fetch(
        `https://ebube-be.onrender.com/api/admin/transactions/withdrawals/${id}/approve`,
        {
          method: "PUT",
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  const rejectWithdrawal = async (id) => {
    try {
      ...
      const response = await fetch(
        `https://ebube-be.onrender.com/api/admin/transactions/withdrawals/${id}/reject`,
        {
          method: "PUT",
          headers: {
            Authorization: `Bearer ${token}`,
