    ...
    const fetchDocument = async () => {
      try {
        ...
        const response = await fetch(
          `https://ebube-be.onrender.com/api/admin/kyc/${kycId}/document`,
          {
            method: "GET",
            headers: {
...
const PendingKYC = () => {
  ...
  const fetchPendingKYC = async () => {
    try {
      ...
      const response = await fetch(
        "https://ebube-be.onrender.com/api/admin/kyc/pending",
        {
          method: "GET",
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  const verifyKYC = async (id) => {
    try {
      ...
      const response = await fetch(
        `https://ebube-be.onrender.com/api/admin/kyc/${id}/verify`,
        {
          method: "PUT",
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  const rejectKYC = async (id) => {
    try {
      ...
      const response = await fetch(
        `https://ebube-be.onrender.com/api/admin/kyc/${id}/reject`,
        {
          method: "PUT",
          headers: {
            Authorization: `Bearer ${token}`,
